...
public class ContractorInvoiceToRecordMapper implements Mapper<ContractorInvoice, ContractorInvoiceRecord>
{
	...
	{
		return new ContractorInvoiceRecord(contractorInvoice.getStartDate(), contractorInvoice.getEndDate(), contractorInvoice.getNumberOfWorkedDays(), contractorInvoice.getTotal(), contractorInvoice.getExtraAmount(), contractorInvoice.getCurrency());
	}
}
