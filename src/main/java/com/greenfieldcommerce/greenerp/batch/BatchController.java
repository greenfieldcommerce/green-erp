...
public class BatchController
{
	...
	public BatchController(final JobLauncher jobLauncher, final Job loadContractorsFromCsv, final Job loadContractorRatesFromCsv, final Job loadContractorInvoicesFromCsv)
	{
		...
		jobs = Map.of("contractors", loadContractorsFromCsv, "rates", loadContractorRatesFromCsv, "invoices", loadContractorInvoicesFromCsv);
	}
