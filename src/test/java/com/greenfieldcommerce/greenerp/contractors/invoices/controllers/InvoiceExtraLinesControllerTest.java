...
public class InvoiceExtraLinesControllerTest extends BaseRestControllerTest
{
	...
	{
		return new ContractorInvoiceRecord(VALID_RESOURCE_ID, VALID_RESOURCE_ID, VALID_RESOURCE_ID, ZonedDateTime.now(), ZonedDateTime.now().plusMonths(1), BigDecimal.valueOf(22), Set.of(extraLine), BigDecimal.valueOf(3600), Currency.getInstance("USD"), "OPEN");
	}
