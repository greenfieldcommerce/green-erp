...
operation::creating-an-invoice[snippets='http-request,request-headers,path-parameters,request-fields,http-response']
...
operation::detailing-current-invoice[snippets='http-request,request-headers,path-parameters,http-response']
